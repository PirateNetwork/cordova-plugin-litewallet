...
export AR=$NDK/x86_64/bin/x86_64-linux-android-ar
export CC=$NDK/x86_64/bin/x86_64-linux-android-clang
export OPENSSL_DIR=$(pwd)/openssl-1.1.1e/openssl-1.1.1e/x86
...
cp ../target/x86_64-linux-android/release/librust.so ../../android/litewallet-jni/libs/x86_64/liblitewallet-jni.so
